...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
    url = "https://github.com/saadparwaiz1/cmp_luasnip"
  },
  ["friendly-snippets"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/friendly-snippets",
  ...
  ["vim-kubernetes"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/vim-kubernetes",
